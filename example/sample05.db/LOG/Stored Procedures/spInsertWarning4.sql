...
--       System::TaskName
--    @p_System_ErrorCode     AS nvarchar(max) = NULL
--       System::ErrorCode
--    @p_System_ErrorDescription AS nvarchar(max) = NULL
--       System::ErrorDescription 
--    @p_User_traceENTITY     AS nvarchar(128)
--       User::traceEntity -or- Name of the table that is involved in this procedure call.
...
--          Created
-- --------------------------------------------------------------------------------
CREATE PROCEDURE [LOG].[spInsertWarning4]
    @p_executionId           AS INT
   ,@p_componentId           AS INT
   ,@p_traceId               AS INT
   ,@p_source                AS NVARCHAR(5)
