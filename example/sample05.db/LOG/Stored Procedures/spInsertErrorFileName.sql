...
--
--              This procedure encapsulates the following parameters:
--
--                @p_errorType  = 'E'
--                @p_source     = 'SSIS'
--                @p_schema     = NULL
...
--       Error Description
--    @p_errorFilename        AS nvarchar(128)
--       Filaneme of imported file with error
...
--          Created
-- --------------------------------------------------------------------------------
CREATE PROCEDURE [LOG].[spInsertErrorFileName]
    @p_executionId           AS int
   ,@p_componentId           AS int
   ,@p_traceId               AS int
   ,@p_source                AS nvarchar(5)
